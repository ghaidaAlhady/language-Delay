"""Top-level factory that loads, validates, and normalizes KB01-KB06."""
from __future__ import annotations

from pathlib import Path

from app.rag.loader import load_all_workbooks, load_kb06_records
...
def build_knowledge_base(kb_dir: Path) -> KnowledgeBase:
    ...
    weekly_followup_questions = normalize_kb06(
        load_kb06_records(kb_dir), "KB06.json"
    )
    ...
    return KnowledgeBase(
        ...
        questions=questions,
        weekly_followup_questions=weekly_followup_questions,
